...
constexpr Score Bonus[VARIANT_NB][PIECE_TYPE_NB][RANK_NB][int(FILE_NB) / 2] = {
...
#ifdef ATOMIC
  {
    ...
    { // Pawn
      ...
      { S(-32,-10), S( 11,-41), S(  0, 3), S( 27, -4) },
      { S(  7,-22), S( 12, 16), S( -2, 1), S( 25,  9) },
      { S(-26,  1), S( 14, 18), S( 31,14), S( 36, 17) },
      { S( 20,  9), S(-30, -1), S(  7,49), S( 17,-15) },
      { S(-11, -8), S( 27, -6), S( -2,21), S(-20, 29) }
    },
    { // Knight
      { S(-149, -99), S(-155,-113), S(-86,-43), S(-84, -2) },
      { S( -78, -52), S( -23, -62), S( -3,-11), S( 17,  3) },
      { S( -35, -62), S( -34, -69), S(  8,  2), S( 19, 28) },
      { S( -14, -32), S( -21, -27), S( 24,  6), S( 27,  8) },
      { S( -35, -33), S(  15, -14), S( 75,  4), S( 66, 77) },
      { S( -11, -67), S(  15, -37), S( 69,  4), S( 91, 40) },
      { S( -64, -73), S(  -8, -17), S( 29, 18), S( 33, 14) },
      { S(-177,-123), S( -60, -84), S(-37,-17), S( -9,-19) }
    },
    { // Bishop
      { S(-56,-90), S(-38, -9), S(-36,-30), S(-70,-10) },
      { S(-48,-72), S( 17,-26), S(-12,-23), S(-23, -3) },
      { S( -1,-34), S(  9,-11), S(  8,-11), S( 10,  1) },
      { S(-17,-36), S( 16,-30), S(  2,-25), S(  8,-16) },
      { S(-37,-17), S( 22,-30), S( 14,-35), S(-11, -5) },
      { S(-49,-21), S( 37, -6), S(  0, -7), S(-17, -2) },
      { S(-36,-53), S( 20,-11), S(-13,-26), S( -5,  9) },
      { S(-49,-63), S(-10,-25), S(-39, -5), S(-45,-35) }
    },
    { // Rook
      { S(-55,-59), S(-18,-15), S( 24, 22), S(  9,-12) },
      { S(-45,-23), S( 24,-11), S( -7,  3), S(-17,-24) },
      { S(-43,  5), S( -5, -5), S(-21, -5), S( 11,  5) },
      { S(-18,-14), S(-25,-11), S(-28, 10), S( 14, -6) },
      { S(-23,-13), S( -3, -9), S(-19,-25), S(-23,  2) },
      { S( 13, -6), S(-18, -7), S( 12,  8), S( 26,  4) },
      { S( 29, 10), S( 16,-18), S( -9, 15), S( 26, -3) },
      { S(-24, 17), S(-11, -5), S( 13, 26), S( -9,  3) }
    },
    { // Queen
      { S(-36,-68), S( -5,-64), S(-36,-41), S( 38,-33) },
      { S(-27,-71), S( 15,-42), S(  5,-19), S(-19,-23) },
      { S(  1,-27), S( 11,-25), S(-12,-22), S( 17,  0) },
      { S(-20,-39), S( 10,-12), S(  5, 13), S(  4, 17) },
      { S(-26,-15), S( 14, 10), S( 10,  6), S(  3, 24) },
      { S(  4,-49), S( -2,-26), S( -3,-35), S( -5, 16) },
      { S( -6,-40), S(  0,-33), S( 31,-14), S(  1, -7) },
      { S( -5,-82), S(-16,-58), S(  9,-35), S(  3,-34) }
    },
    { // King
      { S(269, 22), S(382, 80), S(262, 70), S(169, 46) },
      { S(255, 46), S(290,121), S(207,127), S(157,160) },
      { S(172, 59), S(239,115), S(169,167), S(115,132) },
      { S(187, 95), S(187,156), S(132,161), S(106,203) },
      { S(156, 66), S(176,134), S( 99,182), S( 41,200) },
      { S(118,102), S(167,137), S( 80,158), S( 42,197) },
      { S( 87, 73), S(133, 96), S( 67, 90), S(  2,139) },
      { S( 47,  9), S(108, 57), S( 32, 97), S( 18, 64) }
    }
  },
#endif
#ifdef CRAZYHOUSE
