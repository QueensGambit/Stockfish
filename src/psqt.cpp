...
constexpr Score Bonus[VARIANT_NB][PIECE_TYPE_NB][RANK_NB][int(FILE_NB) / 2] = {
...
#ifdef ATOMIC
  {
    ...
    { // Pawn
      ...
      { S(-31,-10), S( 11,-40), S(  0, 3), S( 28, -4) },
      { S(  7,-22), S( 12, 15), S( -2, 1), S( 25,  9) },
      { S(-26,  1), S( 14, 18), S( 31,14), S( 35, 17) },
      { S( 20,  9), S(-30, -1), S(  7,49), S( 17,-15) },
      { S(-11, -8), S( 27, -6), S( -2,21), S(-20, 29) }
    },
    { // Knight
      { S(-148,-101), S(-156,-115), S(-86,-43), S(-84, -2) },
      { S( -76, -53), S( -23, -63), S( -3,-11), S( 17,  3) },
      { S( -35, -62), S( -34, -70), S(  8,  2), S( 20, 28) },
      { S( -14, -32), S( -22, -28), S( 24,  6), S( 27,  8) },
      { S( -35, -33), S(  15, -14), S( 75,  4), S( 65, 76) },
      { S( -11, -66), S(  15, -37), S( 70,  4), S( 89, 40) },
      { S( -64, -73), S(  -8, -17), S( 29, 18), S( 33, 14) },
      { S(-177,-120), S( -60, -82), S(-37,-17), S( -9,-19) }
    },
    { // Bishop
      { S(-55,-90), S(-38, -9), S(-36,-30), S(-70,-10) },
      { S(-47,-72), S( 17,-26), S(-12,-23), S(-23, -3) },
      { S( -1,-35), S(  9,-11), S(  8,-11), S( 10,  1) },
      { S(-17,-36), S( 16,-30), S(  2,-25), S(  8,-16) },
      { S(-37,-17), S( 22,-30), S( 14,-36), S(-11, -5) },
      { S(-50,-21), S( 37, -6), S(  0, -7), S(-17, -2) },
      { S(-37,-51), S( 20,-11), S(-13,-25), S( -5,  9) },
      { S(-48,-63), S(-10,-25), S(-39, -5), S(-44,-35) }
    },
    { // Rook
      { S(-55,-59), S(-18,-15), S( 23, 22), S(  9,-12) },
      { S(-44,-23), S( 24,-11), S( -7,  3), S(-17,-24) },
      { S(-44,  5), S( -5, -5), S(-21, -5), S( 11,  5) },
      { S(-18,-14), S(-25,-11), S(-28, 10), S( 14, -6) },
      { S(-23,-13), S( -3, -9), S(-19,-25), S(-23,  2) },
      { S( 13, -6), S(-18, -7), S( 12,  8), S( 26,  4) },
      { S( 28, 10), S( 16,-18), S( -9, 15), S( 27, -3) },
      { S(-24, 17), S(-11, -5), S( 13, 26), S( -9,  3) }
    },
    { // Queen
      { S(-36,-69), S( -5,-64), S(-36,-41), S( 38,-33) },
      { S(-27,-71), S( 15,-42), S(  5,-19), S(-19,-23) },
      { S(  1,-27), S( 11,-25), S(-12,-23), S( 17,  0) },
      { S(-20,-38), S( 10,-12), S(  5, 13), S(  4, 17) },
      { S(-26,-15), S( 14, 10), S( 10,  6), S(  3, 24) },
      { S(  4,-50), S( -2,-26), S( -3,-35), S( -5, 16) },
      { S( -6,-39), S(  0,-33), S( 31,-14), S(  1, -7) },
      { S( -5,-81), S(-16,-57), S(  9,-34), S(  3,-34) }
    },
    { // King
      { S(270, 22), S(384, 80), S(267, 69), S(172, 46) },
      { S(253, 46), S(291,120), S(205,126), S(155,160) },
      { S(173, 59), S(233,117), S(170,166), S(115,128) },
      { S(187, 93), S(185,156), S(131,162), S(108,205) },
      { S(156, 66), S(176,135), S( 99,185), S( 41,198) },
      { S(118,101), S(165,136), S( 79,154), S( 41,196) },
      { S( 85, 72), S(135, 96), S( 65, 91), S(  2,138) },
      { S( 47,  9), S(109, 57), S( 32, 96), S( 18, 65) }
    }
  },
#endif
#ifdef CRAZYHOUSE
